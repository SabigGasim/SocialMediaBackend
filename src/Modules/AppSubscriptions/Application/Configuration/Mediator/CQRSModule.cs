...
using SocialMediaBackend.Modules.AppSubscriptions.Infrastructure;
using System.Reflection;

namespace SocialMediaBackend.Modules.AppSubscriptions.Application.Configuration.Mediator;
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.AssignableToAny(
                ...
                typeof(IRequestHandler<>)), publicOnly: false)
