...
namespace SocialMediaBackend.Modules.Chat.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250710075842_RolesAndPermissionsMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMediaBackend.Modules.Chat.Domain.Authorization.Permission", b =>
                {
                    b.Property<int>("Id")
                    ...
                    b.ToTable("Permissions", "chat");

                    b.HasData(
                        new
                        {
                            Id = 0,
                            Name = "Permissions.DirectChat.Create"
                        },
                        new
                        {
                            Id = 1,
                            Name = "Permissions.DirectMessage.Create"
                        },
                        new
                        {
                            Id = 2,
                            Name = "Permissions.DirectMessage.DeleteForEveryone"
                        },
                        new
                        {
                            Id = 3,
                            Name = "Permissions.DirectMessage.DeleteForMe"
                        },
                        new
                        {
                            Id = 4,
                            Name = "Permissions.DirectMessage.GetAll"
                        },
                        new
                        {
                            Id = 5,
                            Name = "Permissions.DirectMessage.MarkAsSeen"
                        },
                        new
                        {
                            Id = 6,
                            Name = "Permissions.GroupChat.Create"
                        },
                        new
                        {
                            Id = 11,
                            Name = "Permissions.GroupChat.Join"
                        },
                        new
                        {
                            Id = 12,
                            Name = "Permissions.GroupChat.KickMember"
                        },
                        new
                        {
                            Id = 13,
                            Name = "Permissions.GroupChat.Leave"
                        },
                        new
                        {
                            Id = 16,
                            Name = "Permissions.GroupChat.PromoteMember"
                        },
                        new
                        {
                            Id = 7,
                            Name = "Permissions.GroupMessage.Create"
                        },
                        new
                        {
                            Id = 8,
                            Name = "Permissions.GroupMessage.DeleteForEveryone"
                        },
                        new
                        {
                            Id = 9,
                            Name = "Permissions.GroupMessage.DeleteForMe"
                        },
                        new
                        {
                            Id = 10,
                            Name = "Permissions.GroupMessage.GetAll"
                        },
                        new
                        {
                            Id = 14,
                            Name = "Permissions.GroupMessage.MarkAsSeen"
                        },
                        new
                        {
                            Id = 15,
                            Name = "Permissions.GroupMessage.MarkAsReceived"
                        });
                });

            modelBuilder.Entity("SocialMediaBackend.Modules.Chat.Domain.Authorization.Role", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialMediaBackend.Modules.Chat.Domain.Conversations.GroupChats.UserGroupChat", b =>
                {
                    ...
                    b.Property<Guid?>("LastReceivedMessageId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LastReceivedMessageId");
            ...
            modelBuilder.Entity("SocialMediaBackend.Modules.Chat.Infrastructure.Domain.Roles.ChatterRole", b =>
                {
                    b.Property<Guid>("ChatterId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ChatterId", "RoleId");

                    b.HasIndex("RoleId");

                    b.ToTable("ChatterRoles", "chat");
                });

            modelBuilder.Entity("SocialMediaBackend.Modules.Chat.Infrastructure.Domain.Roles.RolePermission", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("RolePermissions", "chat");
            ...
            modelBuilder.Entity("SocialMediaBackend.Modules.Chat.Domain.Conversations.GroupChats.UserGroupChat", b =>
                {
                    ...
                    b.HasOne("SocialMediaBackend.Modules.Chat.Domain.Messages.GroupMessages.GroupMessage", "LastReceivedMessage")
                        .WithMany()
                        .HasForeignKey("LastReceivedMessageId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SocialMediaBackend.Modules.Chat.Domain.Messages.GroupMessages.GroupMessage", "LastSeenMessage")
                        .WithMany()
                    ...
                    b.Navigation("LastReceivedMessage");
            ...
            modelBuilder.Entity("SocialMediaBackend.Modules.Chat.Infrastructure.Domain.Roles.ChatterRole", b =>
                {
                    ...
                    b.HasOne("SocialMediaBackend.Modules.Chat.Domain.Authorization.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("SocialMediaBackend.Modules.Chat.Infrastructure.Domain.Roles.RolePermission", b =>
                {
                    b.HasOne("SocialMediaBackend.Modules.Chat.Domain.Authorization.Permission", "Permission")
                        .WithMany()
