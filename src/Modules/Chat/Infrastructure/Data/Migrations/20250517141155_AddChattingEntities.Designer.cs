...
namespace SocialMediaBackend.Modules.Chat.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250517141155_AddChattingEntities")]
    partial class AddChattingEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupChat_Chatters", b =>
                {
                    ...
                    b.HasKey("GroupChatId", "ChatterId");

                    b.HasIndex("ChatterId");

                    b.ToTable("GroupChat_Chatters", "chat");
                });

            modelBuilder.Entity("GroupChat_Moderators", b =>
                {
                    b.Property<Guid>("GroupChatId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GroupChat_Moderators", "chat");
                });
            ...
            modelBuilder.Entity("GroupChat_Chatters", b =>
                {
                    ...
                    b.HasOne("SocialMediaBackend.Modules.Chat.Domain.Conversations.GroupChats.GroupChat", null)
                        .WithMany()
